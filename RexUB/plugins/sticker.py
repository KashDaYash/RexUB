...
from RexUB.modules.helpers.program import get_arg
from RexUB.modules.helpers.filters import command
from RexUB.modules.helpers.decorators import sudo_users_only, errors
...
#         return await kang_msg.edit("`Please Reply to a Sticker!`")
    ...
    packshortname = f"RexUB_{message.from_user.id}_{pack}"
    emoji = "🤔"
    try:
    ...
    if exist:
        ...
        await kang_msg.edit("**Sticker Kanged!** \n\n**Emoji:** {} \n**Pack:** [Here](https://t.me/addstickers/{})".format(emoji, packshortname))
        try:
            if os.path.exists("Kanged_Sticker_RexUB.png"):
                os.remove("Kanged_Sticker_RexUB.png")
