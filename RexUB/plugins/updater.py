...
from RexUB.config import UPSTREAM_REPO, UPSTREAM_BRANCH, OWNER_ID
...
async def update_bot(_, message: Message):
    ...
    if update_avail:
        await msg.edit("**🥀 ʀᴇxᴜʙ Uᴘᴅᴀᴛᴇᴅ\nTᴏ Lᴀᴛᴇsᴛ Vᴇʀsɪᴏɴ 🔥 ...\n\n💕 Rᴇsᴛᴀʀᴛɪɴɢ: Rᴇxᴜʙ Usᴇʀ\nBᴏᴛ, Pʟᴇᴀsᴇ » Wᴀɪᴛ ✨ ...**")
        system("git pull -f && pip3 install -U -r Installer")
        system("python3 -m RexUB")
        return
    await msg.edit(f"**🥀 ʀᴇxᴜʙ Aʟʀᴇᴀᴅʏ\nUᴘᴅᴀᴛᴇᴅ Tᴏ Lᴀᴛᴇsᴛ 🔥 ...\n\n💕 Fᴏʀ Aɴʏ Qᴜᴇʀʏ › Cᴏɴᴛᴀᴄᴛ\nTᴏ » @RexUB ✨ ...**")
...
**🇮🇳 Cᴏᴍᴍᴀɴᴅ :**
`.update` - __Tᴏ Uᴘᴅᴀᴛᴇ ʀᴇxᴜʙ Tᴏ Lᴀᴛᴇsᴛ Vᴇʀsɪᴏɴ ...__
"""
