...
from RexUB.modules.helpers.interval import IntervalHelper
import RexUB.modules.cache.admins

async def get_administrators(chat: Chat) -> List[User]:
    get = RexUB.modules.cache.admins.get(chat.id)
    ...
    if get:
        ...
        RexUB.modules.cache.admins.set(chat.id, to_set)
