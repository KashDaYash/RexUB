...
from motor.motor_asyncio import AsyncIOMotorClient as YaaraOP

from RexUB.config import MONGO_DB_URL, LOG_GROUP_ID, OWNER_ID, STRING_SESSION, SUDO_USERS, UPSTREAM_BRANCH, UPSTREAM_REPO
from RexUB.modules.clientbot.clientbot import client, robot, pytgcalls
from RexUB.utilities.misc import sudo
from RexUB.utilities.times import time_to_seconds
from RexUB.utilities.tasks import install_requirements
...
### Mongo DB
MONGODB_CLI = YaaraOP(MONGO_DB_URL)
db = MONGODB_CLI.KashDaYash
